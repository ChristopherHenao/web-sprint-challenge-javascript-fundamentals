...
const zooAnimals = [
  ...
  */
  ...
  function USApop(data){
    let newArray = [];
    data.forEach(item => newArray.push(item.population));
    return newArray.reduce((total, cv) => total + cv);
  }
...
// The array method callbacks are already in arrow functions, in the requests above
